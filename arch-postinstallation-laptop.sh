...
sudo pacman -S audacity bleachbit dconf-editor evince gnome-calculator gnome-control-center gnome-disk-utility gnome-software gnome-text-editor gnome-tweaks libreoffice-fresh mission-center nautilus pdfarranger picard soundconverter strawberry telegram-desktop vlc
